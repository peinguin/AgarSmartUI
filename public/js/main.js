...
(function(window, jQuery) {
    ...
    function init() {
        ...
        document.getElementById('region').onchange = function () {
            ...
            jQuery('.region-message.' + jQuery('#region').val()).show();
        ...
        window.onresize = ga;
        ga();
        window.requestAnimationFrame ? window.requestAnimationFrame(ha) : setInterval(U, 1E3 / 60);
        setInterval(G, 100);
    ...
    function ea() {
        null == N && (N = {}, jQuery("#region").children().each(function() {
    ...
    function ka() {
        jQuery.ajax("http://m.agar.io/", {error: function() {
                setTimeout(ka, 1E3)
            },success: function(a) {
                a = a.split("\n");
                la("ws://" + a[0])
    ...
    function za(a) {
        ...
        aa && 0 == n.length && jQuery("#overlays").fadeIn(3E3)
    }
    function G() {
    ...
    var S,
        ...
        ba = !1,
        ta = !1,
        fa = "ontouchstart" in window && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
        ca = new Image;
